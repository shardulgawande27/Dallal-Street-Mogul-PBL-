 ...
 */
public class allSector extends javax.swing.JFrame {

    /**
     * Creates new form allSector
     */
    ...
    public void setRecordToTable(){
        try{
            ...
            while (rs.next()){
                ...
                model = (DefaultTableModel)tbl_sectorRecord.getModel();
                model.addRow(obj);
    ...
    public void search(String str){
        ...
        tbl_sectorRecord.setRowSorter(trs);
    ...
    private void initComponents() {
        ...
        tbl_sectorRecord = new javax.swing.JTable();
        ...
        jPanel1.add(txt_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 170, 601, 40));
        ...
        tbl_sectorRecord.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "SymblNo", "CompanyName", "MarketCap", "Cmp", "SectorName"
            }
        ));
        tbl_sectorRecord.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tbl_sectorRecord);
        tbl_sectorRecord.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 1050, 620));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search By Sector");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 0, 1720, 1090));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allSector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbl_sectorRecord;
